                        ...
                        <table class="table table-bordered table-hover" id="table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" rowspan="2" class="align-middle">Brand Name</th>
                                    <th scope="col" rowspan="2" class="align-middle">Brand Code</th>
